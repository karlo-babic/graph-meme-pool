...
def set_global_seed(seed: int):
    ...
    if torch.cuda.is_available():
        ...
        # The following two lines are crucial for GPU determinism
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Create or Load Graph, now with dependencies
        ...
        # Initialize Evolution Engine and Visualizer with shared components
